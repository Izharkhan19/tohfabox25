      ...
      <div className="min-h-[70vh] bg-gray-50 py-20 flex items-center justify-center px-6">
        <div className="max-w-md w-full text-center bg-white rounded-3xl p-10 shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 mb-10">
            Save your favorite handcrafted treasures and access them from any
            device.
          </p>
          <button
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h1 className="flex min-w-0 flex-nowrap items-center gap-2 text-2xl font-bold text-resin-dark font-serif sm:gap-4 sm:text-3xl md:text-4xl">
        ...
        <div className="grid lg:grid-cols-4 gap-12">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                      <button
                        ...
                        className={`w-full py-3 md:py-4 rounded-full font-bold uppercase tracking-widest text-xs transition-all shadow-md shrink-0 ${
                          stock > 0
          ...
          <div className="lg:col-span-1">
            <div className="bg-resin-blue/5 rounded-3xl p-8 sticky top-8 border border-resin-blue/10 text-center">
              ...
              <h2 className="text-2xl font-serif text-resin-dark mb-4">
                Curated Collection
              </h2>
              <p className="text-sm text-gray-600 mb-8 leading-relaxed">
                You have {wishlistItems.length} handcrafted pieces saved. Don't
                wait too long, as our masterworks are often one-of-a-kind.
              </p>
              <Link
                to="/products"
