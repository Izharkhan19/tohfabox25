        ...
        return (
            <div className="min-h-[70vh] bg-gray-50 flex items-center justify-center py-20 px-6">
                <div className="max-w-md w-full bg-white rounded-3xl p-10 text-center shadow-sm border border-gray-100">
                    ...
                    <h2 className="text-3xl font-serif text-resin-dark mb-4">Sign In Required</h2>
                    <p className="text-gray-500 mb-8">Please sign in to view and manage your cart.</p>
                    <button
        ...
        return (
            <div className="min-h-[70vh] bg-gray-50 flex items-center justify-center py-20 px-6">
                <div className="max-w-md w-full text-center">
                    ...
                    <h2 className="text-4xl font-serif text-resin-dark mb-4">Your cart is empty</h2>
                    <p className="text-gray-500 mb-10">Discover unique resin art pieces to add to your collection.</p>
                    <Link
                        to="/products"
                ...
                <div className="grid lg:grid-cols-12 gap-12">
                                    ...
                                    <div className="flex-1 flex flex-col justify-between">
                                        <div className="flex justify-between items-start gap-4">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500 mt-1">{product.artist || "Artisan"}</p>
                                            </div>
                                            <button
                    ...
                    <div className="lg:col-span-4">
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 sticky top-24">
                            <h2 className="text-lg font-bold font-serif text-resin-dark mb-6 border-b border-gray-100 pb-4">Order Summary</h2>
                            ...
                            <div className="border-t border-gray-100 pt-4 mb-8">
                                ...
                                <p className="text-xs text-gray-400 mt-2 text-right">Taxes calculated at checkout</p>
                            </div>
