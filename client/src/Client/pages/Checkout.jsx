...
export default function Checkout() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-24">
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-8 pb-36 lg:pb-12 md:py-12">
        <form
        ...
        >
          ...
          <div className="lg:col-span-5">
            <div className="min-w-0 rounded-3xl border border-gray-100 bg-white p-5 shadow-sm sm:p-8 lg:sticky lg:top-8">
              ...
              <div className="relative my-6 hidden lg:flex items-center py-2">
              ...
              <button
                ...
                className="hidden lg:flex w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-bold h-14 rounded-full tracking-widest uppercase text-sm transition-all shadow-md items-center justify-center gap-3"
              >
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 lg:hidden z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
            <div className="flex justify-between items-center mb-3">
              <span className="font-bold text-gray-900">Total:</span>
              <span className="text-xl font-bold text-resin-dark">₹{total.toFixed(2)}</span>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <button
                type="button"
                onClick={handleWhatsAppOrder}
                className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-bold h-12 rounded-xl tracking-widest uppercase text-sm transition-all shadow-md flex items-center justify-center gap-2"
              >
